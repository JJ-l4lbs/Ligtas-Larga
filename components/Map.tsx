...
export default function MapComponent() {
  ...
  return (
    <>
      {/* Fullscreen Splash Screen Revamp overlay */}
      {showSplash && (
        <div
            ...
            <div className="nav-header-card" style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
              ...
              >
                {!isEditingAddresses ? (
                  <>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                      <span style={{ fontSize: "11px", fontWeight: 800, color: "var(--text-on-app-left-muted)", letterSpacing: "0.5px" }}>
                        ACTIVE ROUTE
                      </span>
                      <button
                        onClick={() => {
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                      ...
                      <div style={{ fontSize: "12px", color: "var(--text-on-app-left-secondary)", textOverflow: "ellipsis", overflow: "hidden", whiteSpace: "nowrap", flex: 1 }}>
                        <strong style={{ color: "var(--text-on-app-left)" }}>From: </strong>{fromAddress || "PUP Manila"}
                      </div>
                    </div>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                      ...
                      <div style={{ fontSize: "12px", color: "var(--text-on-app-left-secondary)", textOverflow: "ellipsis", overflow: "hidden", whiteSpace: "nowrap", flex: 1 }}>
                        <strong style={{ color: "var(--text-on-app-left)" }}>To: </strong>{toAddress || "Master Buffalo"}
                      </div>
                    </div>
                  </>
                ) : (
              ...
              <div style={{ display: "flex", gap: "8px", width: "100%" }}>
                <button
                  ...
                  style={{
                    ...
                    color: isWheelchairEnabled ? "var(--badge-accessible-text)" : "var(--text-on-app-left-secondary)",
                    fontSize: "11px",
                    fontWeight: 700,
                    padding: "10px 4px",
                    borderRadius: "10px",
                ...
                <button
                  ...
                  style={{
                    ...
                    color: isShadedEnabled ? "var(--badge-shaded-text)" : "var(--text-on-app-left-secondary)",
                    fontSize: "11px",
                    fontWeight: 700,
                    padding: "10px 4px",
                    borderRadius: "10px",
                ...
                <button
                  ...
                  style={{
                    ...
                    color: isRainEnabled ? "var(--badge-flood-text)" : "var(--text-on-app-left-secondary)",
                    fontSize: "11px",
                    fontWeight: 700,
                    padding: "10px 4px",
                    borderRadius: "10px",
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: "12px", borderTop: "1.5px solid var(--border-subtle)", paddingTop: "12px" }}>
                    <button
                      ...
                      style={{
                        ...
                        border: "1.5px solid var(--border-subtle)",
                        backgroundColor: "var(--bg-app-left)",
                        color: activeStepIndex === 0 ? "var(--text-on-app-left-muted)" : "var(--text-on-app-left)",
                        fontSize: "12px",
                        fontWeight: 700,
                    ...
                    <button
                      ...
                      style={{
                        ...
                        border: "1.5px solid var(--border-subtle)",
                        backgroundColor: "var(--bg-app-left)",
                        color: activeStepIndex === routeSteps.length - 1 ? "var(--text-on-app-left-muted)" : "var(--text-on-app-left)",
                        fontSize: "12px",
                        fontWeight: 700,
